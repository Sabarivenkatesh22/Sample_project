...
exports.createSendToken = (user, statusCode, res) => {
    ...
    // console.log("hello from createSendToken");
...
exports.login = catchAsync(async (req, res, next) => {
    ...
    // 3) If every check goes perfect, send token to client
...
exports.protectRoute = catchAsync(async (req, res, next) => {
    ...
    // 4) Check if user changed the paswword after the token was issued
